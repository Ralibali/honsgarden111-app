...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://honsgarden-preview.preview.emergentagent.com').rstrip('/')
...
class TestStripeCheckout:
    ...
    def test_checkout_create_monthly_returns_stripe_url(self, auth_session):
        ...
        response = session.post(f"{BASE_URL}/api/checkout/create", json={
            "plan": "monthly",
            "origin_url": "https://honsgarden-preview.preview.emergentagent.com"
        })
