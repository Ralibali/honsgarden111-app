...
async def send_reminder_email(email: str, name: str, coop_name: str):
    ...
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="text-align: center; margin-top: 30px;">
            <a href="https://chicken-hub-redesign.preview.emergentagent.com/api/web/" 
        ...
        <p style="color: #888; font-size: 12px; text-align: center; margin-top: 40px;">
            ...
            <a href="https://chicken-hub-redesign.preview.emergentagent.com/api/web/settings" style="color: #888;">Ändra inställningar</a>
        </p>
    </div>
    """
