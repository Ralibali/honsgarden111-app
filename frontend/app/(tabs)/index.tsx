...
import MICROCOPY, { getTimeBasedGreeting } from '../../src/constants/microcopy';
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        {/* ========== AI-INSIKT SEKTION (matchar web exakt) ========== */}
        <View style={{ marginHorizontal: 16, marginBottom: 16 }}>
          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 12 }}>
              ...
              <Text style={{ fontSize: 12, fontWeight: '600', color: colors.textMuted, letterSpacing: 1 }}>
                AI-INSIKT
              </Text>
            </View>
            ...
            <Text style={{ 
              ...
              {isPremium 
                ? '"Bra jobbat med registreringen! Fortsätt så."'
                : '"Registrera ägg för att få AI-analys."'}
            </Text>
            ...
            <TouchableOpacity
              ...
              onPress={() => isPremium ? handleAiReportPress() : router.push('/paywall')}
              activeOpacity={0.8}
            >
              <Ionicons name="star" size={16} color="#FFF" style={{ marginRight: 8 }} />
              <Text style={{ color: '#FFF', fontSize: 14, fontWeight: '600' }}>
                {isPremium ? 'Se AI-dagsrapport' : 'Lås upp djupare analys'}
              </Text>
            </TouchableOpacity>
          </View>
          
          {/* Två AI-kort under (7-dagars prognos + Få smart flockråd) */}
          <View style={{ flexDirection: 'row', gap: 10, marginTop: 12 }}>
            <TouchableOpacity
              ...
              onPress={() => isPremium ? handleForecastPress() : router.push('/paywall')}
              activeOpacity={0.8}
            >
              <Ionicons name="calendar-outline" size={20} color={colors.primary} style={{ marginRight: 10 }} />
              <Text style={{ fontSize: 13, color: colors.text }}>Se 7-dagars prognos</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              onPress={() => isPremium ? openAgdaModal() : router.push('/paywall')}
              activeOpacity={0.8}
            >
              <Ionicons name="home-outline" size={20} color={colors.primary} style={{ marginRight: 10 }} />
              <Text style={{ fontSize: 13, color: colors.text }}>Få smart flockråd</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={{ marginHorizontal: 16, marginBottom: 16 }}>
          ...
          <View style={{ flexDirection: 'row', gap: 10, marginBottom: 12 }}>
            ...
            >
              ...
              <View>
                <Text style={{ fontSize: 14, fontWeight: '600', color: colors.text }}>Mina hönor</Text>
                <Text style={{ fontSize: 13, color: colors.textMuted }}>{hens.length} st</Text>
              </View>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              onPress={() => router.push('/add-hen')}
              activeOpacity={0.8}
            >
              <Ionicons name="add" size={24} color={colors.primary} style={{ marginRight: 12 }} />
              <Text style={{ fontSize: 14, fontWeight: '600', color: colors.text }}>Lägg till höna</Text>
            </TouchableOpacity>
          </View>
          
          {/* Info om tupp */}
          {!hens.some(h => h.hen_type === 'rooster') && (
            <View style={{
              backgroundColor: colors.surface,
              borderRadius: 12,
              padding: 14,
              ...
              <Ionicons name="information-circle-outline" size={18} color={colors.textMuted} style={{ marginRight: 10, marginTop: 2 }} />
              <Text style={{ fontSize: 13, color: colors.textMuted, flex: 1 }}>
                Du har ingen tupp. En tupp kan hjälpa till att hålla ordning i flocken och varna för rovdjur.
              </Text>
            </View>
          )}
        </View>
        
        {/* ========== ANALYS & EKONOMI SEKTION ========== */}
        <View style={{ marginHorizontal: 16, marginBottom: 24 }}>
          ...
          <View style={{ flexDirection: 'row', gap: 10 }}>
            ...
            >
              ...
              <Text style={{ fontSize: 12, color: colors.text, marginTop: 6 }}>Statistik</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              onPress={() => router.push('/(tabs)/economy')}
              activeOpacity={0.8}
            >
              <Ionicons name="wallet-outline" size={24} color={colors.primary} />
              <Text style={{ fontSize: 12, color: colors.text, marginTop: 6 }}>Ekonomi</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={{ fontSize: 12, color: colors.text, marginTop: 6 }}>Ägglogg</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={{ fontSize: 12, color: colors.text, marginTop: 6 }}>Dela</Text>
            </TouchableOpacity>
          </View>
        </View>
